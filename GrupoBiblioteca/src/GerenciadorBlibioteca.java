...
public interface GerenciadorBlibioteca {
	...
	public Grupo_estudo cadastrarGrupo_estudo(Long id, String nome_responsavel, String tema_estudo, int dias_reuniao ) throws 
	...
	public Grupo_estudo removeGrupo_estudo(Long id, String nome_responsavel, String tema_estudo, int dias_reuniao ) throws 
	IdInvalidoException, Tema_estudoInvalidoException, Dias_reuniaoInvalidoException, NomeInvalidoException;
